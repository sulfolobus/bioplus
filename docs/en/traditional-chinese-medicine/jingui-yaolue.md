...
- **Treating Different Diseases with Same Method**: Different diseases with the same pattern can use the same formula
- **Treating Same Disease with Different Methods**: Same disease with different patterns requires different formulas
- **Emphasis on Prevention**: "When seeing liver disease, know it will affect the spleen, always first strengthen the spleen"

## Modern Application

Formulas from Jingui Yaolue are widely used in modern TCM clinical practice, particularly playing important roles in treating cardiovascular diseases, digestive system diseases, and gynecological disorders.
